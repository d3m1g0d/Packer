# Ubuntu Server 22.04 LTS input variables.
# @author Adrian Heissler

/*
    DESCRIPTION:
    Ubuntu Server 22.04 LTS variables.
...
variable "common_ip_wait_address" {
  type        = string
  description = "The guest operating system IP address."
}
...
variable "vm_ip_address" {
  type        = string
  description = "The IP address of the VM (e.g. 172.16.11.221)."
  default     = null
}
...
variable "vm_ip_gateway" {
  type        = string
  description = "The gateway of the VM (e.g. 172.16.11.1)."
  default     = null
}
